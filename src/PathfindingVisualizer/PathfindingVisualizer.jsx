...
export default class PathfindingVisualizer extends Component {
  ...
  animateDijkstra(visitedNodesInOrder, nodesInShortestPathOrder) {  // animate the dijkstra algorithm
    ...
    for (let i = 0; i <= visitedNodesInOrder.length; i++) {
      ...
      setTimeout(() => {  // set the timeout for the animation
  ...
  animateShortestPath(nodesInShortestPathOrder) { // animate the shortest path
    for (let i = 0; i < nodesInShortestPathOrder.length; i++) { // for each node in the shortest path order
      setTimeout(() => {  // set the timeout for the animation
...
const createNode = (col, row) => { // create a node object
  return {
    col,    // column
    row,    // row
